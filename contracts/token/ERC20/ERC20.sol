 ...
 */
contract ERC20 is Context, IERC20, IERC20Metadata , SphereXProtected {
     ...
     */
    function transfer(address to, uint256 amount) public virtual override sphereXGuardPublic(0xaf122465, 0xa9059cbb) returns (bool) {
     ...
     * `amount`.
     */
    function transferFrom(address from, address to, uint256 amount) public virtual override sphereXGuardPublic(0x31aeebe7, 0x23b872dd) returns (bool) {
     ...
     * - `from` must have a balance of at least `amount`.
     */
    function _transfer(address from, address to, uint256 amount) internal virtual sphereXGuardInternal(0xf0e797dd) {
     ...
     */
    function _spendAllowance(address owner, address spender, uint256 amount) internal virtual sphereXGuardInternal(0xd01ab9a6) {
        uint256 currentAllowance = allowance(owner, spender);
     ...
     * To learn more about hooks, head to xref:ROOT:extending-contracts.adoc#using-hooks[Using Hooks].
     */
    function _afterTokenTransfer(address from, address to, uint256 amount) internal virtual sphereXGuardInternal(0x5819ca77) {}
}
